...
if(isset($_POST['soumis'])){
    if(isset($_POST['nom']) && strlen($_POST['nom'])<= 20 && filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)){
        ...
        // $contenu = trim(htmlspecialchars(addslashes($_POST['desc'])));
        ...
        // $sql2 ="INSERT INTO personne(nom, prenom, age, email, telephone, id_langue, image, description)
        ...
        if(empty($image)){
            ...
            $sql = "UPDATE articles SET titre = '$titre', auteur = '$auteur', id_categorie = '$id_categorie', description = '$description', image = '$image' 
            WHERE id_a = '$id_a'";
        }
